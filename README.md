...
- [spacecloud-io/space-cloud: Open source Firebase + Heroku to develop, scale and secure serverless apps on Kubernetes](https://github.com/spacecloud-io/space-cloud) 
- [Kubernetes Dashboards: Octant | Loft Blog](https://loft.sh/blog/kubernetes-dashboards-octant/?ck_subscriber_id=185276756) 
### June 6, 2021 
...
- [morphagene_audacity.py](https://gist.github.com/ferrihydrite/d7602f94c0aa940ba63f4fae809a2385) 
### January 3, 2021 
...
- [cyberark/kubeletctl: A client for kubelet](https://github.com/cyberark/kubeletctl?utm_sq=ggwhwi562c&v1_5=) 
...
- [Oha — command-line utility in Rust // Lib.rs](https://lib.rs/crates/oha) 
- [Automate Server Configuration with Ansible Playbooks | Linode](https://www.linode.com/docs/applications/configuration-management/running-ansible-playbooks/) 
### July 5, 2020 
...
- [Put your bash code in functions - rand[om]](https://ricardoanderegg.com/posts/bash_wrap_functions/) 
...
- [practical-python/Contents.md at main · dabeaz-course/practical-python](https://github.com/dabeaz-course/practical-python/blob/main/Notes/Contents.md) 
### June 14, 2020 
...
- [Composing in the Caddyfile - Wiki - Caddy Community](https://caddy.community/t/composing-in-the-caddyfile/8291) 
- [10 most common mistakes using kubernetes – pipetail Blog](https://blog.pipetail.io/posts/2020-05-04-most-common-mistakes-k8s/) 
### May 22, 2020 
...
- [Encrypting and storing Kubernetes secrets in Git](https://crypt.codemancers.com/posts/2020-04-27-encrypting-and-storing-kubernetes-secrets-in-git/) 
- [Check disk space usage on linux with Ncdu – BinaryTides](https://www.binarytides.com/check-disk-usage-linux-ncdu/) 
- [Clean up Linux Server Using These Simple Tips](https://ma.ttias.be/clean-up-linux-server-using-these-simple-tips/) 
- [Balthazar – Shell productivity tips and tricks](https://blog.balthazar-rouberol.com/shell-productivity-tips-and-tricks) 
### April 30, 2020 
...
- [ManagedKube/kubernetes-common-services: These services help make it easier to manage your applications environment in Kubernetes](https://github.com/ManagedKube/kubernetes-common-services) 
- [braidchat/braid: Braid is a team-chat app with a novel UI that leads to better conversations.](https://github.com/braidchat/braid) 
### April 10, 2020 
...
- [GitHub - vmware/tern: Open Source compliance for containers](https://github.com/vmware/tern) 
- [My First Kubernetes Clusters with Rancher | Blog Linoproject.net](https://blog.linoproject.net/my-first-kuernetes-clusters-with-rancher/) 
### March 4, 2020 
...
- [rancher/kine](https://github.com/rancher/kine) 
### February 16, 2020 
...
- [GitHub - kayrus/kuttle: Kubernetes wrapper for sshuttle](https://github.com/kayrus/kuttle) 
### February 11, 2020 
...
- [How to write a Cluster API provider for running Kubernetes cluster on baremetal](https://itnext.io/kubernetes-cluster-creation-on-baremetal-host-using-cluster-api-1c2373230a17) 
### January 19, 2020 
...
- [heroku/terrier: Terrier is a Image and Container analysis tool that can be used to scan Images and Containers to identify and verify the presence of specific files according to their hashes.](https://github.com/heroku/terrier) 
### January 18, 2020 
- [A visual guide on troubleshooting Kubernetes deployments](https://learnk8s.io/troubleshooting-deployments) 
...
- [cube2222/jql: Easy JSON Query Processor with a Lispy syntax in Go](https://github.com/cube2222/jql) 
...
- [No Docker Required_ Tools to Build Container Images](https://www.tngtech.com/fileadmin/Public/Images/BigTechday/BTD12/Folien/Slides_MartinHoefling_PatrickHarboeck_compressed.pdf) 
### December 7, 2019 
...
- [Linstor storage with Kubernetes | has_many :codes](https://vitobotta.com/2019/08/07/linstor-storage-with-kubernetes/) 
### October 28, 2019 
...
- [Health Checks like a Pro - AppsFlyer - Medium](https://medium.com/appsflyer/health-checks-like-a-pro-3fa362942883) 
...
- [The Toyota Way - Wikipedia - The 14 Principles](https://en.m.wikipedia.org/wiki/The_Toyota_Way#The_14_Principles) 
...
- [lorin/ansible-quickref: Quick reference for Ansible variables](https://github.com/lorin/ansible-quickref) 
### June 10, 2019 
- [Using cloud-init for VM templating on vSphere - Blah, Cloud.](https://blah.cloud/infrastructure/using-cloud-init-for-vm-templating-on-vsphere/) 
...
- [danicat/pacgo: A Pac Man clone written in Go (with emojis!)](https://github.com/danicat/pacgo/) 
### June 1, 2019 
...
- [Home | Holepunch.io](https://holepunch.io/) 
...
- [machinelearningmindset/machine-learning-course: Machine Learning Course with Python](https://github.com/machinelearningmindset/machine-learning-course) 
### May 13, 2019 
...
- [Docker SDK for Python — Docker SDK for Python 3.7.0 documentation](https://docker-py.readthedocs.io/en/stable/index.html) 
...
- [Bruno Luiz Blog | Kubernetes devops productivity hacks](https://brunoluiz.net/2019/mar/kubernetes-devops-productivity-hacks/) 
### March 26, 2019 
...
- [gRPC Load Balancing inside Kubernetes · Fabrice Aneche](https://blog.nobugware.com/post/2019/kubernetes_mesh_network_load_balancing_grpc_services/) 
...
- [Will it cluster? k3s on your Raspberry Pi](https://blog.alexellis.io/test-drive-k3s-on-raspberry-pi/) 
- [boot2podman/boot2podman: Lightweight Linux for Podman](https://github.com/boot2podman/boot2podman) 
### March 11, 2019 
...
- [go-micro/README.md at master · micro/go-micro](https://github.com/micro/go-micro/blob/master/README.md) 
- [How Accenture retrofitted for site reliability engineering | TechBeacon](https://techbeacon.com/devops/how-accenture-retrofitted-site-reliability-engineering) 
...
- [k3s/README.md at master · rancher/k3s](https://github.com/rancher/k3s/blob/master/README.md) 
### March 2, 2019 
...
- [Building Python Serverless Slack Apps on OpenFaas - Ruan Bekker's Blog](https://blog.ruanbekker.com/blog/2019/02/21/building-python-serverless-slack-apps-on-openfaas/) 
...
- [GitHub - inspec/inspec-vmware: InSpec VMware Resource Pack (Incubation)](https://github.com/inspec/inspec-vmware) 
### February 23, 2019 
...
- [Running Kubernetes without nodes](http://jpetazzo.github.io/2019/02/13/running-kubernetes-without-nodes-with-kiyot/) 
...
- [Building your own Virtual Appliances using OVF properties Part 1](https://www.virtuallyghetto.com/2019/02/building-your-own-virtual-appliances-using-ovf-properties-part-1.html#more-163933) 
...
- [Canary analysis: Lessons learned and best practices from Google and Waze | Google Cloud Blog](https://cloud.google.com/blog/products/devops-sre/canary-analysis-lessons-learned-and-best-practices-from-google-and-waze) 
### January 15, 2019 
...
- [Kube watcher | Watch Kubernetes pods from anywhere](https://kubewatcher.com/) 
### January 9, 2019 
...
- [Creating Highly Available Clusters with kubeadm - Kubernetes](https://kubernetes.io/docs/setup/independent/high-availability/) 
### December 31, 2018 
...
- [My small vim and tmux flow cheatsheet | {“title”: “Who let the dogs out”}](https://hakanu.net/vim/2018/12/20/my-small-vim-and-tmux-flow-cheatsheet/) 
### December 20, 2018 
...
- [Cortex: a multi-tenant, horizontally scalable Prometheus-as-a-Service - Cloud Native Computing Foundation](https://www.cncf.io/blog/2018/12/18/cortex-a-multi-tenant-horizontally-scalable-prometheus-as-a-service/) 
### December 17, 2018 
...
- [On-Prem k8s | Part 6](https://blog.csnet.me/k8s-thw/part6/) 
### December 13, 2018 
...
- [Creating a Simple Slack Bot | Drifting Ruby](https://www.driftingruby.com/episodes/creating-a-simple-slack-bot) 
### December 5, 2018 
...
- [Consul DNS - Kubernetes - Consul by HashiCorp](https://www.consul.io/docs/platform/k8s/dns.html) 
### November 27, 2018 
...
- [Use vSphere Storage as Kubernetes persistent volumes](https://blog.inkubate.io/use-vsphere-storage-as-kubernetes-persistant-volumes/) 
### November 6, 2018 
...
- [CLI Love Inside ❤️ - DEV Community 👩‍💻👨‍💻](https://dev.to/biros/cli-love-inside-4lgl) 
- [Deploying the Kubernetes Dashboard](http://sumglobal.com/deploying-the-kubernetes-dashboard/) 
### November 3, 2018 
...
- [Writing the pre-commit git hook for Go files. – Ignacy Radliński – Medium](https://medium.com/@radlinskii/writing-the-pre-commit-git-hook-for-go-files-810f8d5f1c6f) 
### September 27, 2018 
...
- [Handmade mutex in 28 lines of go – Alexander Borisov – Medium](https://medium.com/@cheshirysh/handmade-mutex-in-28-lines-of-go-205ff5b13dbc) 
- [How to debug a running Go app with VSCode – average-coder – Medium](https://medium.com/average-coder/how-to-debug-a-running-go-app-with-vscode-76e3eac45bd) 
### September 20, 2018 
...
- [Turn your vim editor into a productivity powerhouse | Opensource.com](https://opensource.com/article/18/9/vi-editor-productivity-powerhouse?utm_source=DevOps%27ish&utm_campaign=732adc47f8-092&utm_medium=email&utm_term=0_eab566bc9f-732adc47f8-45838997) 
- [Kubernetes with Cilium and Containerd using Kubeadm - Scott's Weblog - The weblog of an IT pro focusing on cloud computing, Kubernetes, Linux, containers, and networking](https://blog.scottlowe.org/2018/09/06/kubernetes-cilium-containerd-using-kubeadm/?utm_source=DevOps%27ish&utm_campaign=732adc47f8-092&utm_medium=email&utm_term=0_eab566bc9f-732adc47f8-45838997) 
### September 3, 2018 
...
- [Terraform For Teams | Atlantis](https://www.runatlantis.io/) 
### August 31, 2018 
...
- [Start with Golang (part 2) - Build Go API - Hello, world! I'm Huynh Minh Tu](https://mrhmt.com/start-golang-part2/?utm_campaign=Revue%20newsletter&utm_medium=Newsletter&utm_source=Master%20the%20World%20of%20Golang) 
### August 22, 2018 
- [Sysdig | Kubernetes Monitoring with Prometheus, the ultimate guide (part 1)](https://sysdig.com/blog/kubernetes-monitoring-prometheus/) 
...
- [Tips to crack Certified Kubernetes Administrator (CKA) Exam](https://medium.com/@pmvk/tips-to-crack-certified-kubernetes-administrator-cka-exam-c949c7a9bea1) 
...
- [How to set up high availability storage with GlusterFS on Ubuntu 18.04 - TechRepublic](https://www.techrepublic.com/article/how-to-set-up-high-availability-storage-with-glusterfs-on-ubuntu-18-04/) 
### August 17, 2018 
...
- [A small utility for tainting a bunch of terraform resources in one go `terraform state list | grep launch_configuration | tf-multitaint` · GitHub](https://gist.github.com/BRMatt/9b05d38d6c9e293674f0790712cb3d4a) 
### July 29, 2018 
...
- [Aaron Meyer / ESXi_RootPasswordRecovery · GitLab](https://gitlab.com/meyeaard/ESXi_5-6_root_Recovery) 
### July 18, 2018 
...
- [A Tutorial Introduction to Kubernetes](http://okigiveup.net/a-tutorial-introduction-to-kubernetes/?utm_source=DevOps%27ish&utm_campaign=cc611f1d4a-083&utm_medium=email&utm_term=0_eab566bc9f-cc611f1d4a-45838997) 
### July 6, 2018 
...
- [Don’t use Go’s default HTTP client (in production) – Nathan Smith – Medium](https://medium.com/@nate510/don-t-use-go-s-default-http-client-4804cb19f779) 
### June 9, 2018 
